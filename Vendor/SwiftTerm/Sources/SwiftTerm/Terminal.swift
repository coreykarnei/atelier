...
open class Terminal {
    ...
    /// xterm's alternateScroll (`DECSET 1007`): on the alternate screen, with
    /// mouse reporting off, the host turns wheel motion into ↑/↓ key presses.
    public private(set) var alternateScroll: Bool = false
    ...
    func cmdDecRqm (_ pars: [Int], decMode: Bool) {
        ...
        if decMode {
            ...
            case 1007: // alternateScroll
                res = alternateScroll ? modeSet : modeReset
            case 1015:
...
//                break
            ...
            case 1004: // send focusin/focusout events
                   ...
                   // focusout: ^[[O
                sendFocus = true
            case 1007: // alternateScroll — wheel → ↑/↓ on the alternate screen
