...
public class MinimapView: FlippedNSView {
    ...
    override public func hitTest(_ point: NSPoint) -> NSView? {
        // Atelier patch: as a floating scroll-view subview this is asked even
        // while hidden, and answered `self` for its whole column — the text
        // under the (hidden) minimap could not be clicked.
