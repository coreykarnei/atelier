...
extension TextLayoutManager {
    ...
    private func layoutLine(
        ...
        // Atelier patch: upstream shadowed the `inout` with a local copy here,
        // so the widest-line measurement never left this function and the
        // document view never grew past the viewport (no horizontal scroll).
